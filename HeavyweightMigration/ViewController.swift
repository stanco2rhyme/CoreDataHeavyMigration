...
//      users.append(internationalUser)
//    } catch {
...
//    let fetchRequestAlternative: NSFetchRequest<InternationalUser> = InternationalUser.fetchRequest()
//    do {
//      let users = try managedContext.fetch(fetchRequestAlternative)
